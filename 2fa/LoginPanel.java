...
public class LoginPanel extends JPanel {
    ...
    public LoginPanel(AppFrame app, Credentials creds) {
        ...
        JLabel logo = new JLabel(loadLogoResource("/MI_Encrypt.png", 420));
    ...
    // password check first, then 2FA if the account requires it
    ...
    private void doLogin() {
        ...
        if (creds.login(u, p)) {
            ...
            if (account != null && account.isTwoFactorEnabled()) {
